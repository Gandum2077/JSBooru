    ...
    async trigger(name, ...args) {
      ...
      try {
        ...
        promises = this._events[name].map(async listener => {
          ...
          try {
            returned =
              typeof listener.cb === "function" ? listener.cb(...args) : void 0;
            if (
              typeof (returned != null ? returned.then : void 0) === "function"
            ) {
      ...
      if (
        ...
        return typeof (base = this.heartbeat = setInterval(() => {
          ...
          if (
            ...
            incr =
              maximum != null ? Math.min(amount, maximum - reservoir) : amount;
            if (incr > 0) {
